                ...
                maj.rule = FALSE, numCores = 1, verbose = FALSE, F_tester=NULL, F_node_names = list(), orientFnode=TRUE)
{
  ...
  #Use the new Orientation function
  res <- udag2pag_interventional(pag = G, sepset, rules = rules, unfVect = tripleList,verbose = verbose,F_node_names= F_node_names, orientFnode = orientFnode)
...
udag2pag_interventional <- function(pag, sepset, rules = rep(TRUE,10), unfVect = NULL, verbose = FALSE, orientCollider = TRUE,F_node_names=list(),orientFnode=TRUE)
{
